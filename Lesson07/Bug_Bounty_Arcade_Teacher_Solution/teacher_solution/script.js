...
document.getElementById("addPointsBtn").addEventListener("click", () => {
  const points = Number(document.getElementById("pointsSelect").value);
...
document.getElementById("checkCodeBtn").addEventListener("click", () => {
  ...
  const message = document.getElementById("statusMessage"); // BUG: wrong element ID.
  if (code === "ORBIT") {
...
const feedButton = document.getElementById("feedAlienBtn"); // BUG: HTML uses feedAlienBtn.
